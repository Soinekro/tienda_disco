<div>
                ...
                @isset($salesDB)
                    @foreach ($salesDB as $item)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="py-4 px-6">
                                {{ $item->client->name ?? __('Not Client') }}
                            </td>
                            <td class="py-4 px-6">
    ...
    @if ($modalFormVisible)
        <x-dialog-modal wire:model="modalFormVisible">
            ...
            <x-slot name="content">
                <div class="mt-4">
                    <x-label for="ruc" value="{{ __('Documento cliente') }}" />
                ...
                <div class="mt-4">
                    <x-label for="name_provider" value="{{ __('Nombre cliente') }}" />
                ...
                <div class="mt-4 shadow-md border-1 border-blue-300">
                    ...
                    <div class="absolute z-10 w-full bg-white rounded-lg shadow-lg mt-1" x-cloak wire:model="showDrop">
                        @if ($products != [])
                                ...
                                <tbody>
                                    ...
                                    @foreach ($details_products as $detail_product)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ tramsform_cash($detail_product['price_sale']) }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
